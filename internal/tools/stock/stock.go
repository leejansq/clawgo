...
func (t *StockTool) GetQuote(ctx context.Context, symbol string) (*types.QuoteResult, error) {
...
func (t *StockTool) GetHistorical(ctx context.Context, symbol string, period string, interval string) (*types.ChartResult, error) {
	symbol = strings.ToUpper(symbol)
...
// Analyze 分析股票并给出投资建议
func (t *StockTool) Analyze(ctx context.Context, symbol string) (*types.AnalysisResult, error) {
	symbol = strings.ToUpper(symbol)
...
func (t *StockTool) Search(ctx context.Context, query string) ([]types.SearchResult, error) {
...
func analyzeData(q *types.QuoteResult, c *types.ChartResult) *types.AnalysisResult {
...
func calculateTechnicalIndicators(bars []types.KLineBar) types.TechnicalIndicators {
	tech := types.TechnicalIndicators{}
...
func calculateRSI(bars []types.KLineBar) float64 {
	if len(bars) < 14 {
		return 50
	}
...
func generateAnalysis(q *types.QuoteResult, tech types.TechnicalIndicators) string {
...
func generateRecommendation(q *types.QuoteResult, tech types.TechnicalIndicators) types.Recommendation {
